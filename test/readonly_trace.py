...
l2cache = Cache.Cache("L2 Cache", 4, 256, 4, False, True, 4)
...
traceGen.read(blkAddr(3 + 16 * 5 + 5))
...
traceGen.read(blkAddr(4 + 16 * 5 + 2))
traceGen.read(blkAddr(4 + 16 * 4 + 2))
traceGen.read(blkAddr(4 + 16 * 3 + 2))
traceGen.read(blkAddr(4 + 16 * 2 + 2))

traceGen.comment("Counters now:")
l1cache.commentStats(traceGen)
l2cache.commentStats(traceGen)

traceGen.read(blkAddr(4 + 16 * 1 + 2))
